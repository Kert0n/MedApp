...
#h(2em) Приложение представляет из себя Android приложение, back-end сервер для обратки запросов и работой с базой данных. Также присутсвует побочный модуль для получения данных в БД из открытых источников. Ознакомиться с текстом программы можно на сайте Github по ссылке: https://github.com/Kert0n/MedApp
